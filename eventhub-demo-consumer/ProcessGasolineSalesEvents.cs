...
{
    internal class ProcessGasolineSalesEvents
    {
        ...
        public ProcessGasolineSalesEvents(string eventHubName,
        ...
        public async Task ConsumeEventsAsync()
        {
            ...
            string[] partitionIds = new string[] { PartitionMapper.MapPartition(TransactionTypeEnum.Gasoline) };

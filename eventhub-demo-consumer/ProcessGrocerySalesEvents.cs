...
{
    internal class ProcessGrocerySalesEvents
    {
        ...
        public ProcessGrocerySalesEvents(string eventHubName,
        ...
        public async Task ConsumeEventsAsync()
        {
            ...
            string[] partitionIds = new string[] { PartitionMapper.MapPartition(TransactionTypeEnum.Grocery) };
